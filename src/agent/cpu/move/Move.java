...
public abstract class Move {
     ...
     * Gets winning.
     *
     * @return winning. True if after move is done, {@link CPUPlayer} has 15 or
     * more points. False if otherwise.
     */
     ...
     * Sets winning.
     *
     * @param winning boolean value to be set. True if after move is done,
     * {@link CPUPlayer} has 15 or more points. False if otherwise.
     */
     ...
     *
     * @return True if this {@link Move} is better than other {@link Move}.
     * False if otherwise.
     */
